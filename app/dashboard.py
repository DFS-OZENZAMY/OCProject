...
# Titre de la page
st.set_page_config(page_title="Home credit risk", layout="wide")
...
with st.sidebar:
    ...
    st.markdown("""---""")
    st.write("Created by Zenzamy Othmane")


if page == "Home":
    st.title("Home credit risk - Home Page")
...
if page == "Information du client":
    st.title("Home credit risk - Page Information du client")
...
if page == "Interprétation locale":
    st.title("Home credit risk - Page Interprétation locale")
...
if page == "Interprétation globale":
    st.title("Home credit risk - Page Interprétation globale")
